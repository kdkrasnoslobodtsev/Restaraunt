...
public class Main {
    ...
    static ArrayList<VisitorOrder> visitorsOrders;
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Today there are " + visitorsOrders.size() + " visitors");
        ...
        for (VisitorOrder visitor: visitorsOrders) {
    ...
    public static void readJsonFiles() throws IOException {
        ...
        visitorsOrders = objectMapper.readValue(new File("JSON\\visitors_orders.txt"), new TypeReference<ArrayList<VisitorOrder>>() {});
